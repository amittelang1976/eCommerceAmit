...
docker pull amittelang1976/new-api-gateway:latest
docker pull amittelang1976/new-product-service:latest
docker pull amittelang1976/new-order-service:latest
docker pull amittelang1976/new-inventory-service:latest
docker pull amittelang1976/new-notification-service:latest
...
kind load docker-image -n microservices amittelang1976/new-api-gateway:latest
kind load docker-image -n microservices amittelang1976/new-product-service:latest
kind load docker-image -n microservices amittelang1976/new-order-service:latest
kind load docker-image -n microservices amittelang1976/new-inventory-service:latest
kind load docker-image -n microservices amittelang1976/new-notification-service:latest
